...
import {
    WasteTypeControllerServiceInterface
} from './wasteTypeController.serviceInterface';
...
export class WasteTypeControllerService implements WasteTypeControllerServiceInterface {
    ...
    public calculateNearestCollectionPoint(wasteType: string, currentCoordinates: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        ...
        if (currentCoordinates === null || currentCoordinates === undefined) {
            throw new Error('Required parameter currentCoordinates was null or undefined when calling calculateNearestCollectionPoint.');
        }
